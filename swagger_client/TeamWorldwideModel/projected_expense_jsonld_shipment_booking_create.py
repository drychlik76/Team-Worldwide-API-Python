...
class ProjectedExpenseJsonldShipmentBookingCreate(object):
    ...
    """
    swagger_types = {
        'context': 'OneOfProjectedExpenseJsonldShipmentBookingCreateContext',
        'id': 'str',
        'type': 'str',
        'vendor_code': 'str',
        'type': 'str',
    ...
    def __init__(self, context=None, id=None, type=None, vendor_code=None, type='[P] Pickup/Procurement', charge_code='[FRT] FREIGHT CHARGE', reference_number=None, currency='USD', comment=None, amount=None):  # noqa: E501
        """ProjectedExpenseJsonldShipmentBookingCreate - a model defined in Swagger"""  # noqa: E501
        self._context = None
        self._id = None
        self._type = None
    ...
    @property
    def context(self):
        """Gets the context of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501


        :return: The context of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: OneOfProjectedExpenseJsonldShipmentBookingCreateContext
        """
        return self._context

    @context.setter
    def context(self, context):
        """Sets the context of this ProjectedExpenseJsonldShipmentBookingCreate.


        :param context: The context of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: OneOfProjectedExpenseJsonldShipmentBookingCreateContext
        """
    ...
    @property
    def id(self):
        """Gets the id of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501


        :return: The id of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ProjectedExpenseJsonldShipmentBookingCreate.


        :param id: The id of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501


        :return: The type of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ProjectedExpenseJsonldShipmentBookingCreate.


        :param type: The type of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    def vendor_code(self):
        """Gets the vendor_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501


        :return: The vendor_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def vendor_code(self, vendor_code):
        """Sets the vendor_code of this ProjectedExpenseJsonldShipmentBookingCreate.


        :param vendor_code: The vendor_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    def charge_code(self):
        """Gets the charge_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        ...
        :return: The charge_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def charge_code(self, charge_code):
        """Sets the charge_code of this ProjectedExpenseJsonldShipmentBookingCreate.

                  [2H] TWO MAN SVCS - 1 HR MINIMUM          [2M] TWO MAN SVC - PER 1/4 HOUR          [2MD] TWO MAN DELIVERY          [2T] TWO MAN SVCS - 2 HR MIN          [3M] THREE MAN SERVICE          [4M] FOUR MAN SERVICE          [900] DUE ACS          [925] DUE NSC POOL          [950] DUE FB          [ACC] ALAMEDA CORRIDOR CHARGE          [ADF] ADVANCED DUTY FEE          [ADM] ADMINISTRATION FEE          [ADN] AGENT DEBIT NOTE          [ADR] AIRPORT DROP OR RECOVERY          [ADU] ANTI-DUMPING FEE          [ADV] ADVANCE CHECK FEE          [AES] AES FEE          [AGI] AGRICULTURAL HOLD          [ALH] AIRLINE HANDLING          [AMC] ADDITIONAL MACHINE          [APD] APPOINTMENT DELIVERY          [APP] APPOINTMENT PICKUP          [APQ] ANIMAL PLANT QUARANTINE          [AQI] AGRICULTURAL CHARGE          [ARD] A/R RESERVE DEPOSIT          [ATD] ATTEMPTED DELIVERY          [ATP] ATTEMPTED PICKUP          [AWB] AIR WAYBILL FEE          [BAF] BUNKER ADJUSTMENT FACTOR          [BBK] BROKERAGE ON BREAKBULK          [BFI] BAF INCREASE          [BKF] BOOKING FEE          [BLP] BILL OF LADING PREPARATION          [BND] BOND CHARGES          [BOL] BILL OF LADING FEE          [BPF] BOND PREPARATION FEE          [BRK] BROKERAGE          [C&A] CVD/ADD DUTY          [CBF] CUSTOMS BOND FEE          [CBP] CONTINUOUS ENTRY BOND          [CCF] CREDIT CARD FEE          [CDF] C.O.D. FEE          [CEX] CUSTOMS EXAM FEE          [CFO] COLLECT OCEAN FRT          [CFS] CFS CHARGES          [CGS] CARGO SCREENING          [CHS] CHASSIS CHARGE          [CLD] CONTAINER LOADING          [CLE] CLEARANCE AND HANDLING          [CLR] CUSTOMS CLEARANCE & HANDLING          [CM] CONVENTION MATERIAL          [CNF] CONTRACTOR FEE          [COC] COORDINATION AND CONTROL          [COL] COLLECTION FEE          [COM] COMMISSION ON FREIGHT          [COR] COURIER          [CPF] CONSOL / PORT SERVICE FEE          [CPY] COPY OF DOCUMENT OR POD          [CR] CREDIT          [CRE] CRANE CHARGES          [CRN] PRESENTATION OF CARNET          [CRS] CROSS DOCK FEES          [CRT] CRATING & PACKAGING          [CST] CUSTOMS TITLE SEARCH          [CTF] CLEAN TRUCK FEE          [CTG] CARTAGE          [CXB] CONTAINER BUILDUP          [DAD] DAD/DOC/WHSE          [DAP] DELIVERED AT PLACE          [DCR] DOMINICAN CONTAINER RELEASE          [DDP] DELIVERY DUTY PAID          [DEM] DEMURRAGE          [DET] DETENTION          [DGC] DANGEROUS GOODS CERTIFICATE          [DGR] DANGEROUS GOODS          [DIV] DIVERSION FEE          [DK] DOCKS & PIERS          [DLR] DELIVERY          [DO] DELIVERY ORDER          [DPF] DROP FEE          [DRH] DR HANDLING          [DRY] DRAYAGE          [DSB] DISBURSEMENT FEE          [DST] DESTINATION CHARGES          [DTO] DOCUMENT TURNOVER          [DTQ] DUTY - SUBJECT TO LIQUIDATION          [DTY] DUTY AND TAXES          [DVF] DECLARED VALUE FEE          [DVR] DV (CARRIER COST)          [EDF] EXPORT DECLARATION FEE          [EDH] EXPORT DECLARATION HANDLING          [EFH] ENTRY FEE & HANDLING          [ERO] ERRORS & OMISSIONS POLICY          [EXM] EXAMINATION COORDINATION          [FCC] FEE FOR COLLECT CHARGES          [FDA] FOOD & DRUG ENTRY          [FIN] FINANCE CHARGES          [FKL] FORKLIFT FEE          [FRT] FREIGHT CHARGE          [FSC] FUEL SURCHARGE          [FWD] FORWARDING CHARGES          [GRI] GENERAL RATE INCREASE          [GST] GOODS AND SERVICES TAX          [H&M] HOTELS & MALLS          [HAF] HOUSE AIRFREIGHT          [HAP] HOLD AT AIRPORT          [HAZ] HAZARDOUS MATERIALS          [HD1] HANDLING CHARGES (HD1)          [HKD] HONG KONG DELIVERY ORDER          [HKE] HK EXPORT DECLARATION AND FEES          [HKG] HONG KONG GATE CHARGES          [HLS] HEAVY LIFT SURCHARGE          [HMF] HARBOR MAINTENANCE FEES          [HND] HANDLING CHARGES          [HOF] OCEAN FREIGHT          [HST] HARMONIZED SALES TAX          [IAT] IATA DISCOUNT          [IND] INSIDE DELIVERY          [INH] INSIDE CHARGE - 1 HR MIN          [INL] INLAND FRT          [INS] INSURANCE AND SERVICES          [INT] INTEREST          [IOF] OCEAN FREIGHT B/B          [IPI] IPI FEE          [IPR] IPPC PALLET REPLACEMENT          [ISC] AIRLINE SERVICE FEE          [ISF] ISF FILING FEE & HANDLING          [ISP] INSPECTION SERVICES          [ITF] I.T. FEE & HANDLING          [ITV] I.T. VALIDATION FEE          [LDL] LOCAL DELIVERY          [LEG] LEGALIZATION          [LF] LOCATION FEE          [LG] LIFTGATE          [LH] LINE HAUL          [LOC] LETTER OF CREDIT          [LRF] LATE RECAP FEE          [MIS] MISCELLANEOUS          [MS2] COURIER (MS2)          [MSE] MERCHANDISE PROCESSING FEE          [MSG] MESSENGER FEE          [MYF] MARSHALLING YARD FEE          [NAV] NAVCAN          [NRF] NON-RESIDENTIAL FEE          [NSF] NON-SUFFICIENT FUNDS FEES          [OBF] ORIGIN BROKER SERVICE FEE          [OHR] ON HAND REFUSED SHIPMENT CHG          [ONC] ON-CARRIAGE          [OPH] OCEAN PORT HANDLING          [OPS] OCEAN P/S          [ORG] ORIGIN FEE          [ORI] ORION FEE          [OT] OVERTIME/WEEKEND          [OTC] OVER THE COUNTER          [OTH] OTHER CHARGE          [OTL] OUTLAY FOR ADDITIONAL CHARGES          [OVR] OVERRIDE DISCOUNT          [P/S] PROFIT SPLIT          [PCS] PANAMA CANAL SURCHARGE          [PDE] PROOF OF DELIVERY (ELECTRONIC)          [PE] PERSONAL EFFECTS          [PEN] POST ENTRY SERVICES          [PFA] AIRFREIGHT LESS IATA          [PJ] PALLET JACK CHARGE          [PPF] PIER PASS FEE          [PRC] PRE-CARRIAGE          [PSF] PORT SECURITY FEE          [PSS] PEAK SEASON SURCHARGE          [PST] PROVINCIAL SALES TAX          [PUP] PICKUP          [PYP] PAYMENT PROCESSOR FEE          [QST] QUEBEC SALES TAX          [RCF] RECOVERY FEE          [REB] CUSTOMER REBATE / INCENTIVE          [RLD] RESIDENTIAL DELIVERY          [SC] STAIR CARRY          [SCW] STAIR CARRY WEIGHT RATED          [SEB] SINGLE ENTRY BOND          [SEC] SECURITY SURCHARGE          [SED] SHIPPERS EXPORT DECLARATION          [SEM] SEMINAR FEES          [SMR] SEMINAR          [SP] SHORT PAY AUTHORIZED          [SPD] SPECIAL DELIVERY          [SPH] SPECIAL HANDLING SERVICES          [SPP] SPECIAL PICKUP          [SSB] STEAMSHIP LINE BILL OF LADING          [SSP] SERVICE CENTER PERCENTAGE          [STB] SINGLE TRANSACTION BOND          [STF] CONTAINER STUFFING          [STG] STORAGE          [STP] STOP OFF          [T&F] OTHER DUTY TAXES & FEES          [TAR] TARIFF FILING FEES          [TF] TRANSACTION FEE          [THC] TERMINAL HANDLING          [TKP] PU AT TRK TRMNL OFF AIRPORT          [TRL] TRANSLOAD          [TRR] TRASH REMOVAL          [TST] TESTING CHARGE          [TTC] TEAM TECH COMMERCIAL          [TTD] TEAM TECH DELIVERY          [TTR] TEAM TECH RESIDENTIAL          [TYD] TEAM TECH BEYOND DELIVERY          [UNL] UNLOADING          [UPK] UNPACK          [VAC] VACIS EXAMINATION          [VAT] VAT          [WFG] WHARFAGE          [WGD] WHITE GLOVE DELIVERY          [WGT] WEIGHT BASED RATE ADJUSTMENT          [WHI] WAREHOUSE IN          [WHO] WAREHOUSE OUT          [WHS] WAREHOUSING          [WHX] WAREHOUSE TRANSFER          [WIO] WAREHOUSING, IN & OUT          [WT] WAIT TIME          [WTC] WAIT TIME FOR CONTAINERS          [WTD] WAIT TIME AT DESTINATION          [WTF] WIRE TRANSFER FEE          [WTP] WAIT TIME AT ORIGIN          [WWD] WAREHOUSE WITHDRAWALS          [XDP] EXTD DIST TRUCK TERM DROP          [XDR] EXTRA DRAYAGE          [XEX] X-RAY EXAM FEE          [XFR] TRANSFER          [XRC] EXTD DIST TRUCK TERM RECOVERY          [XRT] EXTRA ROUND TRIP        # noqa: E501

        :param charge_code: The charge_code of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    def reference_number(self):
        """Gets the reference_number of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501

        Reference Number for charge  # noqa: E501

        :return: The reference_number of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_number(self, reference_number):
        """Sets the reference_number of this ProjectedExpenseJsonldShipmentBookingCreate.

        Reference Number for charge  # noqa: E501

        :param reference_number: The reference_number of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501

        Currency  # noqa: E501

        :return: The currency of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this ProjectedExpenseJsonldShipmentBookingCreate.

        Currency  # noqa: E501

        :param currency: The currency of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
        if currency is None:
    ...
    @property
    def comment(self):
        """Gets the comment of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501

        Comment  # noqa: E501

        :return: The comment of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this ProjectedExpenseJsonldShipmentBookingCreate.

        Comment  # noqa: E501

        :param comment: The comment of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501

        Amount  # noqa: E501

        :return: The amount of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this ProjectedExpenseJsonldShipmentBookingCreate.

        Amount  # noqa: E501

        :param amount: The amount of this ProjectedExpenseJsonldShipmentBookingCreate.  # noqa: E501
        :type: float
        """
        if amount is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProjectedExpenseJsonldShipmentBookingCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectedExpenseJsonldShipmentBookingCreate):
            return False
